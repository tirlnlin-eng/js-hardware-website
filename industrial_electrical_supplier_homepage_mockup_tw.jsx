export default function IndustrialSupplierHomepage() {
  const brands = [
    {
      brand: '士林電機',
      category: '無熔絲開關 / 接觸器',
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="uppercase tracking-[0.3em] text-sm text-gray-300 mb-4">
              Industrial Electrical Supply Solutions
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-white text-gray-900 px-6 py-3 rounded-2xl font-semibold shadow-lg hover:scale-105 transition">
                立即詢價
              </button>
              <button className="border border-white px-6 py-3 rounded-2xl font-semibold hover:bg-white hover:text-gray-900 transition">
                查看服務
              </button>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-[32px] overflow-hidden shadow-sm">
          <div className="bg-gradient-to-r from-gray-900 to-gray-700 text-white px-10 py-12">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
              <div>
                <div className="w-24 h-24 rounded-3xl bg-white/10 flex items-center justify-center text-3xl font-bold mb-6">
                  AVC
                </div>
                ...
                <p className="text-gray-200 max-w-2xl leading-relaxed">
                  提供束線帶、固定座、配線槽與各類配線相關產品。
                  適用於工業設備、自動化控制盤與配電工程應用。
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <button className="border border-white/30 px-6 py-4 rounded-2xl font-semibold hover:bg-white hover:text-gray-900 transition">
                  線上詢價
                </button>
              </div>
            </div>
          ...
          <div className="p-10">
            <div className="grid lg:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <button
                  key={category}
                  className="bg-gray-50 border border-gray-200 rounded-3xl p-8 hover:shadow-lg hover:-translate-y-1 transition text-left"
                >
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <button className="text-sm border border-gray-200 px-4 py-2 rounded-full hover:bg-gray-900 hover:text-white transition">
                        詢價
                      </button>
                    </div>
                  ))}
              ...
              <div className="bg-gray-900 text-white rounded-3xl p-8">
                ...
                <div className="mt-10 p-6 bg-white/10 rounded-2xl border border-white/10">
                  ...
                  <button className="bg-white text-gray-900 px-5 py-3 rounded-xl font-semibold hover:scale-105 transition">
                    立即詢問
                  </button>
                </div>
              </div>
      ...
      <section className="bg-gray-900 text-white py-24">
        <div className="max-w-5xl mx-auto text-center px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white text-gray-900 px-8 py-4 rounded-2xl font-semibold hover:scale-105 transition">
              LINE 詢價
            </button>
            <button className="border border-white px-8 py-4 rounded-2xl font-semibold hover:bg-white hover:text-gray-900 transition">
              Email 聯絡
            </button>
          </div>
        </div>
